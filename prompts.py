...
GENERAL_RESUME_IMPROVEMENT_PROMPT = """
    ...
    - Every role should include measurable accomplishments. If a role lacks impact metrics, suggest precise numbers or performance indicators to add. Make sure that the performance indicators and metrics are real and not unbelievable or too unrealistic. Suggest otherwise directly.
    ...
    - No action verbs must repeat within the resme. If a verb is repeated, suggest a strong replacement verb directly.
